...
export const CHALLENGE_PROPOSALS: readonly ChallengeProposal[] = [
...

  {
    ...
    description: 'The starting running back with the most fantasy points.',
    requiredYahooData: ['roster_selected_position', 'player_week_points', 'player_position'],
    calculation: { type: 'highest_single_starter_score', positions: ['RB'] },
    objective: 'maximize',
    tieBreakers: ['worse_record', 'commissioner_decides'],
    benchCounts: false,
    decimalsCount: true,
...

  {
    ...
    week: 8,
    name: 'Tight End Day',
    description: 'The starting tight end with the most fantasy points.',
    requiredYahooData: ['roster_selected_position', 'player_week_points', 'player_position'],
    calculation: { type: 'highest_single_starter_score', positions: ['TE'] },
    objective: 'maximize',
    tieBreakers: ['worse_record', 'commissioner_decides'],
    benchCounts: false,
    decimalsCount: true,
...

  {
    ...
    description: 'The starting defence with the most fantasy points.',
    requiredYahooData: ['roster_selected_position', 'player_week_points', 'player_position'],
    calculation: {
      type: 'highest_single_starter_score',
      positions: ['DEF', 'DST', 'D/ST'],
    },
    objective: 'maximize',
    tieBreakers: ['worse_record', 'commissioner_decides'],
    benchCounts: false,
...

  {
    ...
    week: 7,
    name: 'Air Raid',
    description: 'The starting quarterback with the most fantasy points.',
    requiredYahooData: ['roster_selected_position', 'player_week_points', 'player_position'],
    calculation: { type: 'highest_single_starter_score', positions: ['QB'] },
    objective: 'maximize',
    tieBreakers: ['worse_record', 'commissioner_decides'],
    benchCounts: false,
    decimalsCount: false,
...

  {
    ...
    description: 'The starting wide receiver with the most receptions.',
    requiredYahooData: ['roster_selected_position', 'player_stat_by_id', 'player_position'],
    calculation: {
      type: 'highest_stat_total',
      yahooStatIds: [11],
...

  {
    ...
    description: 'The team whose starters scored the most offensive touchdowns.',
    requiredYahooData: ['roster_selected_position', 'player_stat_by_id'],
    calculation: {
      type: 'highest_stat_total',
      // Passing, rushing and receiving touchdowns, added together.
      yahooStatIds: [5, 10, 13],
      statLabel: 'offensive touchdowns',
      subject: 'team',
    },
    objective: 'maximize',
    tieBreakers: ['worse_record', 'commissioner_decides'],
